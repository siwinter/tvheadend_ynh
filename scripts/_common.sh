...
if [ -n "$(uname -m | grep arm)" ]
    then
        pkg_dependencies="libavahi-client3 libavahi-common3 libavcodec58 libavformat58 libavfilter7 libavresample4 \
                      libavutil56 libc6 libdbus-1-3 libdvbcsa1 libhdhomerun4 libssl1.1 liburiparser1 zlib1g  \
                      lsb-base dvb-apps"
                      
        tvheadend_zip_url="$sources_url/tvheadend_4.2.8-dmo1_armhf.zip"
    else
        pkg_dependencies="libavahi-client3 libavahi-common3 libavcodec58 libavfilter7 libavformat58 libavresample4 \
                      libavutil56 libc6 libdbus-1-3 libdvbcsa1 libhdhomerun4 libssl1.1 liburiparser1 zlib1g \
                      lsb-base dvb-apps bzip2"
